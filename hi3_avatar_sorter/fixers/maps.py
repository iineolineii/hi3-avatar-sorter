...
if TYPE_CHECKING:
    from ..types import RawReplacementMap
...
WRONG_BATTLESUIT_ID_REPLACEMENT_MAP: "RawReplacementMap" = {
    ...
    # to 50 in the raw Valkyrie map.
    #
    # EDGE CASE: Unrealistically likely to happen, but if a new Kallen Battlesuit
    # appears, the below list must be extended accordingly.
...
WRONG_NOTE_REPLACEMENT_MAP: "RawReplacementMap" = {
    (1, ELYSIA, 2, 4, 1, "ShadownIcon"): (1, ELYSIA, 2, 4, 1, "ShadowIcon"),
